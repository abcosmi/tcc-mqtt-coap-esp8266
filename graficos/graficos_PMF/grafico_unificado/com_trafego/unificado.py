...
for t in [1,2,4,7]:
	...
	with open("/home/arthurcosmi/PG_testes/teste_ms/MQTT/comTrafego/ArduinoMqtt-qos0-NTP/output/test_1_qos_0_time_"+str(t)+"_nesp_1_tmsg_10.dat","r") as f1:
		for line in f1:
			info = line.split(" ")
			x1.append(int(info[0]))
	...
	with open("/home/arthurcosmi/PG_testes/teste_ms/MQTT/comTrafego/qos0-NTP2/output/test_1_qos_0_time_"+str(t)+"_nesp_1_tmsg_10.dat","r") as f2:
		for line in f2:
			info = line.split(" ")
			x1.append(int(info[0]))
			avg3.append(int(info[1]))
	...
	plt.hist([avg1,avg2,avg3],weights=[weights1,weights2,weights3],bins=15, color=["blue","green","red"], normed=False, alpha=0.5)
	...
	plt.ylabel('PMF')
	plt.legend(["CoAP","MQTT com Nagle","MQTT sem Nagle"],loc='upper left')
