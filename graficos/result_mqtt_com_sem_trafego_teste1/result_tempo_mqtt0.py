...
for t in [1,5,10,30,60]:
	...
	with open("/home/arthurcosmi/PG_testes/MQTT/semTrafego/qos0/ArduinoMqtt-teste2/output/test_0_qos_0_time_"+str(t)+"_nesp_1.dat","r") as f:
		for line in f:
			info = line.split(" ")
	...
	with open("/home/arthurcosmi/PG_testes/MQTT/comTrafego/qos0/ArduinoMqtt-teste2/output/test_1_qos_0_time_"+str(t)+"_nesp_1.dat","r") as f:
		for line in f:
			info = line.split(" ")
	...
	ax.set_ylabel("Tempo Médio de Chegada em Segundos")
	ax.legend((p1[0], p2[0]), ('sem Tráfego', 'com Tráfego'),shadow=True,fontsize='small')
	ax.grid(True)
	#plt.xlim(x_pos[0]-1,x_pos[4] + 1)
	plt.ylim(t-0.01,t+0.01)
	#autolabel(p1)

	#plt.show()
	plt.savefig("tempo"+str(t)+".eps",format='eps',bbox_inches='tight')
